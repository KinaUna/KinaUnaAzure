...
//            // Act
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(null, start, end, false, TODO);
...
//            // Act
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(rule, start, end, false, TODO);
...
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(dailyRule, start, end, false, TODO);
...
//            // Act
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(weeklyRule, start, end, false, TODO);
...
//            // Act
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(monthlyRule, start, end, false, TODO);
...
//            // Act
//            List<CalendarItem> results = await service.GetCalendarItemsForRecurrenceRule(yearlyRule, start, end, false, TODO);
