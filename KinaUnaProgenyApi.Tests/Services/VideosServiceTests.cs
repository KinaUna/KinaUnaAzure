    ...
    public class VideosServiceTests
    {
        ...
        public async Task DeleteVideo_Should_Remove_From_Cache()
        {
            ...
            _mockKinaUnaCacheService
                ...
                .ReturnsAsync((VideosListCacheEntry)null!);

            _mockKinaUnaCacheService
                .Setup(x => x.GetProgenyOrFamilyTimelineUpdatedCache(1, 0, KinaUnaTypes.TimeLineType.Video))
            ...
            _mockKinaUnaCacheService
                .Setup(x => x.SetVideoListCache(userInfo.UserId, 1, It.IsAny<Video[]>()))
                .Returns(Task.CompletedTask);
        ...
        public async Task SetVideosListInCache_Should_Return_List_And_Cache_It()
        {
            ...
            // Act
            Video[]? result = await service.SetVideosListInCache(1);
