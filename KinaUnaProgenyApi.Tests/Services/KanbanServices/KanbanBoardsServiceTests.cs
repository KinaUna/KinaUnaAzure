...
namespace KinaUnaProgenyApi.Tests.Services.KanbanServices
{
    public class KanbanBoardsServiceTests
    {
        ...
        public KanbanBoardsServiceTests()
        {
            ...
            // Setup default cache behavior (return null = cache miss)
            _mockDistributedCache
                .Setup(x => x.GetAsync(It.IsAny<string>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync((byte[])null!);

            _mockKinaUnaCacheService
                .Setup(x => x.GetKanbanBoardsListCache(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>()))
                .ReturnsAsync((KanbanBoardsListCacheEntry)null!);
            ...
            _mockKinaUnaCacheService
                .Setup(x => x.SetKanbanBoardsListCache(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<KanbanBoard[]>()))
        ...
        [Fact]
        public async Task GetKanbanBoardById_WhenBoardInCache_ReturnsCachedBoard()
        {
            // Arrange
            int boardId = 1;
            ...
            _mockAccessManagementService
                ...
                .ReturnsAsync(itemPermission);
            _mockDistributedCache
                .Setup(x => x.GetAsync(Constants.AppName + Constants.ApiVersion + "kanbanBoard" + boardId, It.IsAny<CancellationToken>()))
        ...
        public async Task AddKanbanBoard_WhenUserHasProgenyAccess_AddsBoard()
        {
            ...
            _mockKinaUnaCacheService.Verify(
                x => x.SetProgenyOrFamilyTimelineUpdatedCache(1, 0, KinaUnaTypes.TimeLineType.KanbanBoard),
                Times.Once);
        }
        ...
        public async Task AddKanbanBoard_WhenUserHasFamilyAccess_AddsBoard()
        {
            ...
            _mockKinaUnaCacheService.Verify(
                x => x.SetProgenyOrFamilyTimelineUpdatedCache(0, 1, KinaUnaTypes.TimeLineType.KanbanBoard),
                Times.Once);
        }
        ...
        public async Task GetKanbanBoardsForProgenyOrFamily_WhenProgenyIdProvided_ReturnsProgenyBoards()
        {
            ...
            _mockKinaUnaCacheService.Verify(
                x => x.SetKanbanBoardsListCache(_testUser.UserId, 1, 0, It.IsAny<KanbanBoard[]>()),
                Times.Once);
        }
        ...
        [Fact]
        public async Task GetKanbanBoardsForProgenyOrFamily_WhenCacheHit_ReturnsCachedData()
        {
            // Arrange
            KanbanBoardsRequest request = new()
            {
            ...
            _mockKinaUnaCacheService
                .Setup(x => x.GetKanbanBoardsListCache(_testUser.UserId, 1, 0))
                .ReturnsAsync(cacheEntry);
            _mockKinaUnaCacheService
                .Setup(x => x.GetProgenyOrFamilyTimelineUpdatedCache(1, 0, KinaUnaTypes.TimeLineType.KanbanBoard))
                .ReturnsAsync(timelineCacheEntry);
            ...
            // Verify cache was used and database not queried again
            _mockKinaUnaCacheService.Verify(
                x => x.SetKanbanBoardsListCache(It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<KanbanBoard[]>()),
                Times.Never);
        }
        ...
        [Fact]
        public async Task GetKanbanBoardsListForProgenyOrFamily_WhenCacheHit_ReturnsCachedData()
        {
            // Arrange
            KanbanBoard[] cachedBoards = await _progenyDbContext.KanbanBoardsDb
                .Where(k => k.ProgenyId == 1 && !k.IsDeleted)
