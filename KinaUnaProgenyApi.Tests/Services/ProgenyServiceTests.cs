...
//            Mock<ILocationService> locationService = new();
//            Mock<IAccessManagementService> accessManagementService = new();
//            ProgenyService progenyService = new(context, memoryCache, imageStore.Object, locationService.Object, accessManagementService.Object);

//            Progeny resultProgeny = await progenyService.GetProgeny(1, new UserInfo());
//            // 2nd call to GetProgeny is retrieving the Progeny object from cache.
//            Progeny resultProgenyCached = await progenyService.GetProgeny(1, new UserInfo());
...
//            Progeny progeny = await progenyService.GetProgeny(0, new UserInfo());
...
//            Progeny addedProgeny = await progenyService.AddProgeny(progenyToAdd, TODO);
//            Progeny? dbProgeny = await context.ProgenyDb.AsNoTracking().SingleOrDefaultAsync(p => p.Id == addedProgeny.Id);
//            Progeny savedProgeny = await progenyService.GetProgeny(addedProgeny.Id, new UserInfo());
...
//            Progeny progenyToUpdate = await progenyService.GetProgeny(1, new UserInfo());
//            progenyToUpdate.Name = "B";

//            Progeny resultProgeny = await progenyService.UpdateProgeny(progenyToUpdate, TODO);
//            Progeny? dbProgeny = await context.ProgenyDb.AsNoTracking().SingleOrDefaultAsync(p => p.Id == resultProgeny.Id);
//            Progeny savedProgeny = await progenyService.GetProgeny(resultProgeny.Id, new UserInfo());
...
//            Progeny progenyToDelete = await progenyService.GetProgeny(1, new UserInfo());

//            _ = await progenyService.DeleteProgeny(progenyToDelete, TODO);
//            Progeny? dbProgeny = await context.ProgenyDb.AsNoTracking().SingleOrDefaultAsync(p => p.Id == 1);
//            Progeny savedProgeny = await progenyService.GetProgeny(1, new UserInfo());
