...
namespace KinaUnaProgenyApi.Tests.Services
{
    public class PicturesServiceTests
    {
        ...
        public async Task GetPicture_Should_Return_Picture_When_User_Has_Permission()
        {
            ...
            _mockAccessManagementService
                .Setup(x => x.GetItemPermissionForUser(KinaUnaTypes.TimeLineType.Photo, 1, 1, 0, userInfo))
        ...
        public async Task GetPicturesList_Should_Return_Pictures_When_User_Has_Permission()
        {
            ...
            _mockAccessManagementService
                .Setup(x => x.GetItemPermissionForUser(KinaUnaTypes.TimeLineType.Photo, It.IsAny<int>(), 1, 0, userInfo))
                .ReturnsAsync(new TimelineItemPermission { PermissionLevel = PermissionLevel.View });
        ...
        //    PicturesService service = new PicturesService(context, cache, _mockImageStore.Object, _mockAccessManagementService.Object);
