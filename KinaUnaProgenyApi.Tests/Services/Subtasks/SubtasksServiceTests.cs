...
namespace KinaUnaProgenyApi.Tests.Services.Subtasks
{
    public class SubtasksServiceTests
    {
        ...
        public SubtasksServiceTests()
        {
            ...
            // Initialize service
            _service = new SubtasksService(_progenyDbContext, _mockAccessManagementService.Object);
        ...
        public async Task UpdateSubtask_WhenUserHasAccess_UpdatesSubtask()
        {
            ...
            _mockAccessManagementService
                ...
                .ReturnsAsync(true);
            _mockAccessManagementService
                .Setup(x => x.UpdateItemPermissions(It.IsAny<KinaUnaTypes.TimeLineType>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<List<ItemPermissionDto>>(), _testUser))
        ...
        public async Task UpdateSubtask_WhenStatusChangesToCancelled_ResetsCompletedDate()
        {
            ...
            _mockAccessManagementService
                ...
                .ReturnsAsync(true);
            _mockAccessManagementService
                .Setup(x => x.UpdateItemPermissions(It.IsAny<KinaUnaTypes.TimeLineType>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<List<ItemPermissionDto>>(), _adminUser))
                .ReturnsAsync(new List<TimelineItemPermission>());
