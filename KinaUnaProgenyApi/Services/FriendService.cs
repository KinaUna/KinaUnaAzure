...
namespace KinaUnaProgenyApi.Services
{
    public class FriendService : IFriendService
    {
        ...
        public async Task<Friend> AddFriend(Friend friend, UserInfo currentUserInfo)
        {
            ...
            await _accessManagementService.AddItemPermissions(KinaUnaTypes.TimeLineType.Friend, friendToAdd.FriendId, friendToAdd.ProgenyId, 0, friendToAdd.ItemPermissionsDtoList, currentUserInfo);
        ...
        public async Task<Friend> UpdateFriend(Friend friend, UserInfo currentUserInfo)
        {
            ...
            await _accessManagementService.UpdateItemPermissions(KinaUnaTypes.TimeLineType.Friend, friendToUpdate.FriendId, friendToUpdate.ProgenyId, 0, friendToUpdate.ItemPermissionsDtoList, currentUserInfo);
