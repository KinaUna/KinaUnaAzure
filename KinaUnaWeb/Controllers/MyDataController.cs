...
{
    public class MyDataController(IProgenyHttpClient progenyHttpClient) : Controller
    {
        ...
        public async Task<FileResult> ChildSpreadSheet(int progenyId)
        {
            ...
            //        titleRange.Style.Font.SetFromFont("Arial", 28, true);
            ...
            //    {
            //        headerRange.Style.Font.SetFromFont("Arial", 11, true);
            ...
            //        photosWorksheet.Cells[photoRowNumber, 2].Value = pic.PictureTime?.ToString("dd-MMM-yyyy HH:mm:ss") ?? "";
            ...
            //        videosWorksheet.Cells[videoRowNumber, 2].Value = vid.VideoTime?.ToString("dd-MMM-yyyy HH:mm:ss") ?? "";
            ...
            //        videosWorksheet.Cells[videoRowNumber, 6].Value = vid.Duration?.ToString("g") ?? "";
            ...
            //        {
            //            evt.StartTime = TimeZoneInfo.ConvertTimeFromUtc(evt.StartTime.GetValueOrDefault(),
            //                TimeZoneInfo.FindSystemTimeZoneById(userTimeZone));
            //            calendarWorksheet.Cells[calendarRowNumber, 3].Value = evt.StartTime.GetValueOrDefault().ToString("dd-MMM-yyyy HH:mm");
            //        }
            //        if (evt.EndTime.HasValue)
            //        {
            //            evt.EndTime = TimeZoneInfo.ConvertTimeFromUtc(evt.EndTime.GetValueOrDefault(),
            //                TimeZoneInfo.FindSystemTimeZoneById(userTimeZone));
            //            calendarWorksheet.Cells[calendarRowNumber, 4].Value = evt.EndTime.GetValueOrDefault().ToString("dd-MMM-yyyy HH:mm");
            //        }
            ...
            //        {
            //            locationsWorksheet.Cells[locationsRowNumber, 6].Value = loc.Date.GetValueOrDefault().ToString("dd-MMM-yyyy");
            //        }
            ...
            //        {
            //            vocabularyWorksheet.Cells[vocabularyRowNumber, 4].Value = voc.Date.GetValueOrDefault().ToString("dd-MMM-yyyy");
            //        }
            ...
            //        {
            //            skillsWorksheet.Cells[skillsRowNumber, 3].Value = skill.SkillFirstObservation.GetValueOrDefault().ToString("dd-MMM-yyyy");
            //        }
            ...
            //        {
            //            friendsWorksheet.Cells[friendsRowNumber, 3].Value = friend.FriendSince.GetValueOrDefault().ToString("dd-MMM-yyyy");
            //        }
            ...
            //        {
            //            Address addr = await _locationsHttpClient.GetAddress(contact.AddressIdNumber.GetValueOrDefault());
            ...
            //        {
            //            contactsWorksheet.Cells[contactsRowNumber, 22].Value = contact.DateAdded.GetValueOrDefault().ToString("dd-MMM-YYYY");
            //        }
