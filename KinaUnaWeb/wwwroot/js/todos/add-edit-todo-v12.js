...
import { getCurrentLanguageId, setMomentLocale, getZebraDateTimeFormat, getLongDateTimeFormatMoment, validateDateValue, getCurrentItemFamilyId, getCurrentItemProgenyId } from '../data-tools-v12.js';
 ...
 * */
export async function initializeAddEditTodo(itemId) {
    languageId = getCurrentLanguageId();
    currentProgenyId = getCurrentItemProgenyId();
    currentFamilyId = getCurrentItemFamilyId();
    await setupDateTimePicker();
    await setupForIndividualOrFamilyButtons(itemId, TimeLineType.TodoItem, currentProgenyId, currentFamilyId);
    setupRichTextEditor();
    const titleInput = document.getElementById('todo-title-input');
    if (titleInput) {
...
//# sourceMappingURL=add-edit-todo-v12.js.map