...
async function getScheduledTasks() {
    ...
    await fetch('/Admin/LoadScheduledTasks', {
        ...
        if (getScheduledTasksResult != null) {
            ...
            console.log(getScheduledTasksResult);
            currentScheduledTasks = (await getScheduledTasksResult.json());
 ...
 */
function setScheduledTasksTableContent(scheduledTasks) {
    const scheduledTasksListTable = document.querySelector('#tasks-list-table');
    if (scheduledTasksListTable !== null) {
        const headerRow = document.querySelector('#tasks-list-table-header');
 ...
 */
function addTaskItemToTable(taskItem) {
    const tasksListTable = document.querySelector('#tasks-list-table');
 ...
 */
function createIdColumn(taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createSaveButtonColumn(taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createNameColumn(taskName, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createDescriptionColumn(taskDescription, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createCommandColumn(apiEndpoint, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createParametersColumn(parameters, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createIsEnabledColumn(isEnabled, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createLastRunColumn(lastRun, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createIsRunningColumn(isRunning, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createIntervalMinutesColumn(intervalMinutes, taskId) {
 ...
 * @returns HTMLTableCellElement
 */
function createDeleteColumn(taskId) {
...
async function addNewTask() {
    startFullPageSpinner();
    let taskId = 0;
    let taskNameInput = document.querySelector('#task-name-input' + taskId);
    let taskDescriptionInput = document.querySelector('#task-description-input' + taskId);
    let parametersInput = document.querySelector('#parameters-input' + taskId);
    let intervalMinutesInput = document.querySelector('#interval-minutes-input' + taskId);
    let isEnabledInput = document.querySelector('#is-enabled-input' + taskId);
    let commandSelectList = document.querySelector('#command-select-list' + taskId);
    // Todo: validate input.
    let taskToUpdate = new BackgroundTaskDto();
...
async function getCommands() {
    await fetch('/Admin/GetCommands', {
        ...
        if (getCommandsResult != null) {
            commands = (await getCommandsResult.json());
        }
    }).catch(function (error) {
 ...
 */
function addCommandsSelectList(taskId, selectedCommand) {
...
//# sourceMappingURL=scheduled-tasks-v10.js.map