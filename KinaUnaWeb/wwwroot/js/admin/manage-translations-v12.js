 ...
 * @returns
 */
function hideElementDelay(milliseconds) {
...
function setTranslationsListTableContent(content) {
    const translationsListTable = document.querySelector('#translations-list-table');
    if (translationsListTable !== null) {
        const headerRow = document.querySelector('#translations-list-table-header');
 ...
 */
function createWordColumn(word) {
 ...
 * @returns The HTMLTableCellElement to append to the table row.
 */
function createLanguageColumn(languageId) {
 ...
 * @returns The HTMLTableCellElement to append to the table row.
 */
function createTranslationColumn(translationItem) {
 ...
 */
function addTranslationItemToTable(translationItem, translationSetCount) {
    const translationsListTable = document.querySelector('#translations-list-table');
    if (translationsListTable === null) {
        return;
    }
...
//# sourceMappingURL=manage-translations-v12.js.map