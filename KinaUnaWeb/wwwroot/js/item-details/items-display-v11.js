import { addPictureItemEventListeners, popupPictureDetails } from '../pictures/picture-details-v11.js';
import { addCalendarEventListeners, popupEventItem } from '../calendar/calendar-details-v11.js';
import { addVideoItemEventListeners, popupVideoDetails } from '../videos/video-details-v11.js';
import { addNoteEventListeners, popupNoteItem } from '../notes/note-details-v11.js';
import { addSleepEventListeners, popupSleepItem } from '../sleep/sleep-details-v11.js';
import { addFriendItemListeners, popupFriendItem } from '../friends/friend-details-v11.js';
import { addContactItemListeners, popupContactItem } from '../contacts/contact-details-v11.js';
import { addLocationItemListeners, popupLocationItem } from '../locations/location-details-v11.js';
import { addMeasurementItemListeners, popupMeasurementItem } from '../measurements/measurement-details-v11.js';
import { addSkillItemListeners, popupSkillItem } from '../skills/skill-details-v11.js';
import { addVocabularyItemListeners, popupVocabularyItem } from '../vocabulary/vocabulary-details-v11.js';
import { addVaccinationItemListeners, popupVaccinationItem } from '../vaccinations/vaccination-details-v11.js';
import { addTodoItemListeners, popupTodoItem } from '../todos/todo-details-v11.js';
import { startFullPageSpinner, stopFullPageSpinner } from '../navigation-tools-v11.js';
import { addKanbanBoardListeners, popupKanbanBoard } from '../kanbans/kanban-board-details-v11.js';
/**
...
//# sourceMappingURL=items-display-v11.js.map