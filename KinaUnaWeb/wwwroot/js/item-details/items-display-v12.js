import { addPictureItemEventListeners, popupPictureDetails } from '../pictures/picture-details-v12.js';
import { addCalendarEventListeners, popupEventItem } from '../calendar/calendar-details-v12.js';
import { addVideoItemEventListeners, popupVideoDetails } from '../videos/video-details-v12.js';
import { addNoteEventListeners, popupNoteItem } from '../notes/note-details-v12.js';
import { addSleepEventListeners, popupSleepItem } from '../sleep/sleep-details-v12.js';
import { addFriendItemListeners, popupFriendItem } from '../friends/friend-details-v12.js';
import { addContactItemListeners, popupContactItem } from '../contacts/contact-details-v12.js';
import { addLocationItemListeners, popupLocationItem } from '../locations/location-details-v12.js';
import { addMeasurementItemListeners, popupMeasurementItem } from '../measurements/measurement-details-v12.js';
import { addSkillItemListeners, popupSkillItem } from '../skills/skill-details-v12.js';
import { addVocabularyItemListeners, popupVocabularyItem } from '../vocabulary/vocabulary-details-v12.js';
import { addVaccinationItemListeners, popupVaccinationItem } from '../vaccinations/vaccination-details-v12.js';
import { addTodoItemListeners, popupTodoItem } from '../todos/todo-details-v12.js';
import { startFullPageSpinner, stopFullPageSpinner } from '../navigation-tools-v12.js';
import { addKanbanBoardListeners, popupKanbanBoard } from '../kanbans/kanban-board-details-v12.js';
/**
...
//# sourceMappingURL=items-display-v12.js.map