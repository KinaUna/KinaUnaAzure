import { ItemPermissionDto, PermissionLevel } from "./page-models-v10.js";
...
export function setPermissions() {
    const timelineItemPermissionsList = [];
    const permissionTypeSelect = document.getElementById('permission-type-select');
    const permissionType = permissionTypeSelect.value;
    const inheritPermissionsInput = document.getElementById('inherit-permissions-input');
    const itemPermissionsListAsStringInput = document.getElementById('item-permissions-list-as-string-input');
...
//# sourceMappingURL=item-permissions-v10.js.map