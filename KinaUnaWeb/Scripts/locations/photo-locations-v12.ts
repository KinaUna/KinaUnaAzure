...
import { LocationItem, LocationsPageParameters, NearByPhotosRequest, NearByPhotosResponse, Picture, PicturesLocationsRequest, PicturesLocationsResponse, TimeLineItemViewModel, TimelineItem } from '../page-models-v12.js';
import { setUpMapClickToShowLocationListener, setupHereMaps, setupHereMapsPhotoLocations } from './location-tools-v12.js';
