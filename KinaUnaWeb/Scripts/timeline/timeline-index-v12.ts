...
import { TimelineItem, TimelineParameters, TimeLineItemViewModel, TimelineList, TimelineResponse, TimelineRequest, TimeLineType } from '../page-models-v12.js';
import {
    getCurrentProgenyId, getCurrentLanguageId, setMomentLocale, getZebraDateTimeFormat, getLongDateTimeFormatMoment,
...
import { startFullPageSpinner, startFullPageSpinner2, startLoadingItemsSpinner, startTopMenuSpinner, stopFullPageSpinner, stopFullPageSpinner2, stopLoadingItemsSpinner, stopTopMenuSpinner } from '../navigation-tools-v12.js';
...
async function initialSettingsPanelSetup(): Promise<void> {
    ...
    if (toggleShowFiltersButton !== null) {
        const toggleShowFilterAction = function (event: MouseEvent) {
