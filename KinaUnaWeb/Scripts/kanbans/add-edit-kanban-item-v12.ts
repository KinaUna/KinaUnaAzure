...
import {
    setTagsAutoSuggestList, setContextAutoSuggestList, getCurrentProgenyId, getCurrentLanguageId, setMomentLocale, getZebraDateTimeFormat,
    getLongDateTimeFormatMoment, validateDateValue, setLocationAutoSuggestList, getCurrentItemFamilyId, getCurrentItemProgenyId
 ...
 */
function setupRichTextEditor(containerElementId: string) {
    const containerElement = document.getElementById(containerElementId);
    if (containerElement !== null) {
        if (containerElement.querySelector('script') !== null) {
            eval((containerElement.querySelector('script') as HTMLElement).innerHTML);
        }
 ...
 * */
export async function initializeAddEditKanbanItem(containerElementId: string, itemId: string): Promise<void> {
