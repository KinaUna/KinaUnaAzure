...
import { KanbanBoard, KanbanBoardColumn, KanbanItem, TimelineItem, TimeLineType, TodoStatusType } from "../page-models-v12.js";
...
import { displayKanbanItemDetails, getAddKanbanItemForm, getEditKanbanItemForm, getKanbanItemsForBoard, getRemoveKanbanItemForm, updateKanbanItem } from "./kanban-items-v12.js";
...
function addTimelineChangedEventListener(): void {
    ...
    const kanbanBoardTimelineChangedAction = async (event: TimelineChangedEvent) => {
...
export function hideAllMenusAndModals(event: MouseEvent): void {
    ...
    if (!target.closest('.item-details-content') && target.closest('.item-details-popup')) {
        let itemDetailsPopupDiv = target.closest('.item-details-popup') as HTMLDivElement;
