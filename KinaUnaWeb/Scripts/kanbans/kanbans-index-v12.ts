...
import { setContextAutoSuggestList, setTagsAutoSuggestList, TimelineChangedEvent } from "../data-tools-v12.js";
...
import { KanbanBoardElementParameters, KanbanBoardsPageParameters, KanbanBoardsPageResponse, TimelineItem, TimeLineType } from "../page-models-v12.js";
...
function addTimelineChangedEventListener() {
    ...
    const kanbanIndexTimelineChangedAction = async (event: TimelineChangedEvent) => {
