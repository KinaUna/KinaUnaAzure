import { popupEventItem } from "../calendar/calendar-details-v11.js";
import { popupContactItem } from "../contacts/contact-details-v11.js";
import { popupFriendItem } from "../friends/friend-details-v11.js";
import { popupPictureDetails } from "../pictures/picture-details-v11.js";
import { popupVideoDetails } from "../videos/video-details-v11.js";
import { popupNoteItem } from "../notes/note-details-v11.js";
import { popupSleepItem } from "../sleep/sleep-details-v11.js";
import { popupLocationItem } from "../locations/location-details-v11.js";
import { popupMeasurementItem } from "../measurements/measurement-details-v11.js";
...
import { popupSkillItem } from "../skills/skill-details-v11.js";
import { popupVaccinationItem } from "../vaccinations/vaccination-details-v11.js";
import { popupVocabularyItem } from "../vocabulary/vocabulary-details-v11.js";
/**
...
export function updateNoficationElementEvents(notificationButtonsList: HTMLCollectionOf<Element>): void {
    if (notificationButtonsList !== null) {
        Array.from(notificationButtonsList).forEach((notificationElement) => {
            ...
            const notificationClickedAction = async function (event: MouseEvent) {
            ...
            if (markReadButton !== null) {
                Array.from(markReadButton).forEach((markReadElement) => {
                    ...
                    const markReadAction = async function (event: MouseEvent) {
                        event.stopImmediatePropagation();
            ...
            if (deleteButton !== null) {
                Array.from(deleteButton).forEach((deleteElement) => {
                    ...
                    const deleteButtonAction = async function (event: MouseEvent) {
                        event.stopImmediatePropagation();
