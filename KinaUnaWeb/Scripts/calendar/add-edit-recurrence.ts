...
function updateRecurrenceByDayInput() {
    const byDayInput = document.querySelector<HTMLInputElement>('#event-repeat-days-input');
    const frequencySelect = document.querySelector<HTMLSelectElement>('#event-repeat-frequency-select');
...
function updateRepeatMonthlyDaysInput() {
    ...
    let eventRepeatMonthlyDaysInput = document.querySelector<HTMLInputElement>('#event-repeat-monthly-days-input');
    ...
    if (frequencyValue === 4) {
        eventRepeatMonthlyDaysInput = document.querySelector<HTMLInputElement>('#event-repeat-yearly-days-input');
        const yearlyByDayPrefixCheckboxes = document.querySelectorAll<HTMLInputElement>('.event-repeat-yearly-by-day-prefix-checkbox');
