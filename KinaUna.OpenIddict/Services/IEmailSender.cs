namespace KinaUna.OpenIddict.Services
{
    ...
    public interface IEmailSender
    {
        ...
        /// <returns></returns>
        Task SendEmailConfirmationAsync(string? email, string link, int languageId = 1);
        ...
        /// <param name="languageId">The Id of the KinaUnaLanguage text should be shown in.</param>
        /// <returns></returns>
        Task SendEmailUpdateConfirmationAsync(string? email, string link, int languageId = 1);
