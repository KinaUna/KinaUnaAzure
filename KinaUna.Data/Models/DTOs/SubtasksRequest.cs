...
{
    /// <summary>
    /// Defines the request model for retrieving subtasks associated with a parent to-do item.
    /// </summary>
    public class SubtasksRequest
    {
        ...
        /// <summary>
        /// Gets or sets the list of Id for the progeny to get Todos for.
        /// </summary>
        public int ProgenyId { get; set; }

        /// <summary>
        /// Gets or sets the list of Id for the family to get Todos for.
        /// </summary>
